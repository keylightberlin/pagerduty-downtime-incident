...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(53);
...
const pagerduty = {
    ...
    token: _actions_core__WEBPACK_IMPORTED_MODULE_0___default().getInput('pagerduty_token'),
    from: _actions_core__WEBPACK_IMPORTED_MODULE_0___default().getInput('pagerduty_from'),
    serviceId: _actions_core__WEBPACK_IMPORTED_MODULE_0___default().getInput('pagerduty_service_id'),
};
(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const resp = yield axios__WEBPACK_IMPORTED_MODULE_1___default().get(_actions_core__WEBPACK_IMPORTED_MODULE_0___default().getInput('endpoint'));
        _actions_core__WEBPACK_IMPORTED_MODULE_0___default().setOutput("status", resp.status);
    }
    catch (e) {
        yield axios__WEBPACK_IMPORTED_MODULE_1___default().post(`${pagerduty.url}/incidents`, {
            incident: {
                type: "incident",
                title: `Health check is failing for ${_actions_core__WEBPACK_IMPORTED_MODULE_0___default().getInput('endpoint')}`,
                service: {
        ...
        _actions_core__WEBPACK_IMPORTED_MODULE_0___default().setOutput("status", e.status);
    }
}))().catch((err) => {
